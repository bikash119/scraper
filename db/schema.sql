...
-- with state information propagated through the hierarchy
...
-- Insert default state for Odisha
INSERT INTO states (state_id, name, version)
VALUES ('odisha', 'Odisha', 1)
ON CONFLICT (state_id, version) DO NOTHING; 